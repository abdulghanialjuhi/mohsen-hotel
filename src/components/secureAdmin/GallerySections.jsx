...
export default function Gallery() {
    ...
    const [keys] = useState(['imgName', 'sectionLabel'])
    const tableName = 'gallery'
    const tableName1 = 'gallery'
    ...
    return (
        <div className='w-full h-full'>
            <Table tableName={tableName1} data={data} keys={keys} handleDelete={handleDelete} setData={setData} />
