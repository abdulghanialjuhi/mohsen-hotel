...
export default function Promotions() {
    ...
    return (
        <div className='w-full h-full'>
            <Table handleEditRecord={handleEditRecord} editable={true} tableName={tableName} data={data} keys={keys} handleDelete={handleDelete} setData={setData} />
            <AddDataForm keys={keys} tableName={tableName} setData={setData} primaryKey={primaryKey} />
            {showEditForm && <EditDataForm recrodData={recrodData} setShowForm={setShowEditForm} showEditForm={showEditForm} keys={keys} tableName={tableName} setData={setData} primaryKey={primaryKey} />}
        </div>
    )
}
